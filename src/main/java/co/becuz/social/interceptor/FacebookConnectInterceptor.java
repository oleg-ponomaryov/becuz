package co.becuz.social.interceptor;
...
import co.becuz.social.dto.FacebookDTO;
...
public class FacebookConnectInterceptor implements ConnectInterceptor<Facebook> {
	...
	public FacebookConnectInterceptor(UserTaskService userTaskService) {
