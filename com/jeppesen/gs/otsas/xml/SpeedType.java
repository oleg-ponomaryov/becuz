...
/**
 * speed type definition (value and correction)
 * 
 ...
 *                 &lt;attribute name="unit" type="{http://aeec.aviation-ia.net/633}speedUnitType" default="kt" />
 *               &lt;/extension>
 *             &lt;/simpleContent>
 *           &lt;/complexType>
 *         &lt;/element>
...
public class SpeedType {
    ...
    /**
     * speed type definition (value and correction) Gets the value of the content property.
     * 
     * <p>
     ...
     * {@link JAXBElement }{@code <}{@link SpeedType.Value }{@code >}
     * {@link String }
     * {@link JAXBElement }{@code <}{@link SpeedType.CorrectedValue }{@code >}
     * 
     * 
     */
    ...
    public static class CorrectedValue {
         ...
         *     
         */
        public SpeedUnitType getUnit() {
            if (unit == null) {
                return SpeedUnitType.KT;
            } else {
                return unit;
            }
        }
         ...
         *     
         */
        public void setUnit(SpeedUnitType value) {
            this.unit = value;
        }
